...
struct ExchangeManager {
    ...
    let currencyArray = ["--- 통화 선택 ---", "아랍에미리트 디르함", "호주 달러", "바레인 디나르", "브루나이 달러", "캐나다 달러", "스위스 프랑", "중국 위안화", "덴마크 크로네", "유럽 유로", "영국 파운드", "홍콩 달러", "인도네시아 루피아", "일본 엔", "한국 원", "쿠웨이트 디나르", "말레이시아 링기트", "노르웨이 크로네", "뉴질랜드 달러", "사우디 리얄", "스웨덴 크로나", "싱가포르 달러", "태국 바트", "미국 달러"]
